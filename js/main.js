	...
	var mobileMenu = function() {
		if ( $(window).width() < 769 ) {
			...
			if ( $('#fh5co-mobile-menu').length < 1 ) {
				...
				$('#fh5co-logo-mobile-wrap').append('<a href="#" class="js-fh5co-nav-toggle fh5co-nav-toggle fh5co-nav-white " data-toggle="collapse" data-target="#fh5co-navbar" aria-expanded="false" aria-label="Navbar" ><i></i></a>');
